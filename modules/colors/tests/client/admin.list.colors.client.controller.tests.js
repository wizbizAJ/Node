(function () {
  ...
  describe('Admin Colors List Controller Tests', function () {
    // Initialize global variables
    var ColorsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _ColorsService_) {
      ...
      $httpBackend.whenGET('/modules/colors/client/views/list-colors.client.view.html').respond(200, '');
      ...
      ColorsAdminListController = $controller('ColorsAdminListController as vm', {
        $scope: $scope
      });
