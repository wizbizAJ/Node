(function () {
  ...
  describe('Admin Character_types List Controller Tests', function () {
    // Initialize global variables
    var Character_typesAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _Character_typesService_) {
      ...
      $httpBackend.whenGET('/modules/character_types/client/views/list-character_types.client.view.html').respond(200, '');
      ...
      Character_typesAdminListController = $controller('Character_typesAdminListController as vm', {
        $scope: $scope
      });
