(function () {
  ...
  describe('Campaign_types List Controller Tests', function () {
    // Initialize global variables
    var Campaign_typesListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _Campaign_typesService_) {
      ...
      Campaign_typesListController = $controller('Campaign_typesListController as vm', {
        $scope: $scope
      });
