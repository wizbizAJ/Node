(function () {
  ...
  describe('Admin Departments List Controller Tests', function () {
    // Initialize global variables
    var DepartmentsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _DepartmentsService_) {
      ...
      $httpBackend.whenGET('/modules/departments/client/views/list-departments.client.view.html').respond(200, '');
      ...
      DepartmentsAdminListController = $controller('DepartmentsAdminListController as vm', {
        $scope: $scope
      });
