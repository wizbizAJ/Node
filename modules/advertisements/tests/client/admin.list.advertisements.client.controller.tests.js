(function () {
  ...
  describe('Admin Advertisements List Controller Tests', function () {
    // Initialize global variables
    var AdvertisementsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _AdvertisementsService_) {
      ...
      $httpBackend.whenGET('/modules/advertisements/client/views/list-advertisements.client.view.html').respond(200, '');
      ...
      AdvertisementsAdminListController = $controller('AdvertisementsAdminListController as vm', {
        $scope: $scope
      });
